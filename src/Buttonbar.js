...
class Buttonbar extends React.Component {
  ...
  render() {
    ...
    <div className="w3-bar btnBar">
        ...
        <Link to="/modify" className="w3-bar-item w3-button w3-ripple" title="Modify Task" aria-label="Modify Task"> <RemoveCircleIcon fontSize="large" className="w3-indigo" /> </Link>
